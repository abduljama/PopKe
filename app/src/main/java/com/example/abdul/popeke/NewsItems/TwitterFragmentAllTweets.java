 ...
 */
public class TwitterFragmentAllTweets extends Fragment{
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        list = (RecyclerView) viewlltweets.findViewById(R.id.listalltweets);
...
//        });
    ...
    private class DownloadTwitterTask extends AsyncTask<String, Void, Wrapper> {
        ...
        final static String TwitterSearchURL = "https://api.twitter.com/1.1/statuses/user_timeline.json?count=100&screen_name=";
